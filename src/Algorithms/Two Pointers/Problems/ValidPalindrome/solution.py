# A Valid Palindrome is where you can remove at most one character to make a palindrome
...
# Example usage:
print(valid_palindrome_ii("abca")) # Output: True (remove 'c' or 'b')
print(valid_palindrome_ii("abc"))  # Output: False