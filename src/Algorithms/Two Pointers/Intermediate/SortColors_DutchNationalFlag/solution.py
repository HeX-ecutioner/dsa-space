# Sort Colors (Dutch National Flag) - 3-way partition using three pointers
# Problem: Given array with values 0,1,2 sort them in-place.
...
# Example:
# nums = [2,0,2,1,1,0] -> after sort_colors -> [0,0,1,1,2,2]
